...
class CommandSeedResetTest extends TestCase
{
    public function testSeedersAreAllRollbacked(): void
    {
        ...
        $this->artisan('seed:reset')->assertSuccessful();

        Event::assertDispatchedTimes('migration.down', 2);
        Event::assertNotDispatched('migration.up');

        $this->assertDatabaseMissing('seeders', ['seeder' => '0000_00_00_000000_test_seeder']);
